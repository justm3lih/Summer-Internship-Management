      ...
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-slate-900 to-indigo-950 p-6 md:p-8 text-white shadow-lg border border-slate-800">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl md:text-4xl font-bold tracking-tight">Knowledge Base Editor</h1>
            <p className="text-slate-300 max-w-2xl text-sm md:text-base leading-relaxed">
              Create, update, and manage guidelines, regulations, and deadlines that feed the AI
